...
namespace Xiuse.DbUtility
{
	...
	public sealed class OleDbHelper
	{
        ...
        /// <returns></returns>
        public static DataSet ExecuteDataset(string connectionString, CommandType commandType,int startRecord, int maxRecord, out int recordCount, string commandText, params OleDbParameter[] parameters)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
