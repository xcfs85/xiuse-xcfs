...
namespace Xiuse.DbUtility
{
    ...
    public sealed class SqlHelper
    {
       ...
       /// <param name="commandType">执行类型[表名,存储过程,SQL语句]</param>
        ...
        /// <returns></returns>
        public static DataSet ExecuteDataset(string connectionString,CommandType commandType,int startRecord, int maxRecord, out int recordCount, string commandText, params SqlParameter[] parameters)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
