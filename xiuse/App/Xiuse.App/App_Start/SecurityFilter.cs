...
namespace Xiuse.App
{
    public class SecurityFilter : ActionFilterAttribute
    {
        public override void OnActionExecuting(System.Web.Http.Controllers.HttpActionContext actionContext)
        {
            ...
            //GetToken方法不需要进行签名验证
            if (actionContext.ActionDescriptor.ActionName == "Authenticated"|| actionContext.ActionDescriptor.ActionName == "Key" || actionContext.ActionDescriptor.ActionName == "KeyClient")
            {
