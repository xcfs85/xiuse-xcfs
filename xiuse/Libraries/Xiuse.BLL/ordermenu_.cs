...
namespace Xiuse.BLL
{
    ...
    public class ordermenu_ 
    {
        ...
        /// <returns></returns>
        private static List<Xiuse.Model.ordermenu_> DataSetTransModelListNoExpand(DataSet dataSet)
        {
        ...
        /// <param name="dataSet"></param>
        /// <returns></returns>
        private static Xiuse.Model.ordermenu_ DataSetTransModelNoExpand(DataSet dataSet)
        {
            if (dataSet != null && dataSet.Tables.Count > 0 && dataSet.Tables[0].Rows.Count > 0)
            {
