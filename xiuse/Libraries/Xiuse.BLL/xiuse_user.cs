...
namespace Xiuse.BLL
{
    ...
    public class xiuse_user 
    {
        ...
        /// <returns></returns>
        private static List<Xiuse.Model.xiuse_user> DataSetTransModelListNoExpand(DataSet dataSet)
        {
        ...
        /// <param name="dataSet"></param>
        /// <returns></returns>
        private static Xiuse.Model.xiuse_user DataSetTransModelNoExpand(DataSet dataSet)
        {
            if (dataSet != null && dataSet.Tables.Count > 0 && dataSet.Tables[0].Rows.Count > 0)
            {
