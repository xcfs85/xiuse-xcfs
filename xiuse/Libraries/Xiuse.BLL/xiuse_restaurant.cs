...
namespace Xiuse.BLL
{
    ...
    public class xiuse_restaurant 
    {
        ...
        /// <returns></returns>
        private static List<Xiuse.Model.xiuse_restaurant> DataSetTransModelListNoExpand(DataSet dataSet)
        {
        ...
        /// <param name="dataSet"></param>
        /// <returns></returns>
        private static Xiuse.Model.xiuse_restaurant DataSetTransModelNoExpand(DataSet dataSet)
        {
            if (dataSet != null && dataSet.Tables.Count > 0 && dataSet.Tables[0].Rows.Count > 0)
            {
